...
@WebFilter(urlPatterns = {"/ConsumerIndex", "/addShoppingBag", "/ShoppingBagWaiting", "/ShoppingBagValidation", "/consumerCommandList", "/consumerCommand"})
public class FilterNotConnectedOrNotConsumer implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        else
        {
            ...
            if(user.getAdmin() == true || user.getTrader() == true)
            {
